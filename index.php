  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a style="background-color: #01A5CB" class="nav-link active" aria-current="page"  href="index.php">Inicio</a>
        </li>
...
<div id="carru">
<div class="carousel-inner" width="50%" height= "500px">
  <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel" class="carousel-inner">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="carousel-inner" src="imagenes/pasto/pas.jpeg" class="d-block w-100" alt="..." >
    ...
    <div class="carousel-item">
      <img class="carousel-inner" src="imagenes/pasto/pas2.jpeg" class="d-block w-100" alt="imagenes/pasto/pas3.jpg">
      <div class="carousel-caption d-none d-md-block">
    ...
    <div class="carousel-item">
      <img class="carousel-inner" class="carousel-inner" src="imagenes/pasto/pas3.jpg" class="d-block w-100" alt="imagenes/tierra.jpg">
      <div class="carousel-caption d-none d-md-block">
...
<footer class="bg-light text-center text-black" class="carousel-inner">
  <div class="container p-4">
  ...
  <div class="card" style="width: 18rem;">
        <img src="imagenes/follaje/pared.jpeg" class="card-img-top" alt="...">
  <div class="card-body">
         <h5 class="card-title">Card title</h5>
         <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
         <a hidden="" href="#" class="btn btn-primary">Go somewhere</a>
  </div>
  </div>
  </div>
  ...
  <div class="col-auto">
  <div class="card" style="width: 18rem;">
        <img src="imagenes/follaje/pared2.jpeg" class="card-img-top" alt="...">
  <div class="card-body">
        <h5 class="card-title">Card title</h5>
        <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
        <a hidden="" href="#" class="btn btn-primary">Go somewhere</a>
  ...
  <div class="col-auto">
  <div class="card" style="width: 18rem;">
        <img src="imagenes/follaje/pared4.jpeg" class="card-img-top" alt="...">
  <div class="card-body">
        <h5 class="card-title">Card title</h5>
        <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
        <a hidden="" href="#" class="btn btn-primary">Go somewhere</a>
